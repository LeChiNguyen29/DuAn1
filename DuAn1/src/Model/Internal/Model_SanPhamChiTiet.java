...
public class Model_SanPhamChiTiet {
    ...
    public Model_SanPhamChiTiet(String maSanPham, String tenSanPham, int soLuong, int donGia) {
        this.maSanPham = maSanPham;
    ...
    public Object[] toDataRowKhachHang() {
        return new Object[] {getMaSanPham(), getTenSanPham(), getSoLuong(), getDonGia()};
    }
