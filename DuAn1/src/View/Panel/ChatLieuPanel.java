...
private DiaLogThongBao diaLogThongBao = new DiaLogThongBao();
    ...
    private void initComponents() {
        ...
        tblChatLieu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã", "Tên Chất Liệu", "Trạng Thái", "Id"
            }
        ) {
        ...
        tblChatLieu.setSelectionBackground(new java.awt.Color(0, 153, 153));
        ...
        if (tblChatLieu.getColumnModel().getColumnCount() > 0) {
            tblChatLieu.getColumnModel().getColumn(3).setMinWidth(0);
            tblChatLieu.getColumnModel().getColumn(3).setPreferredWidth(0);
            tblChatLieu.getColumnModel().getColumn(3).setMaxWidth(0);
        }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ChatLieuModel chatLieu = this.getForm();
        if (chatLieu == null) {
            return;
        } else {
            if (chatLieuService.checkMaChatLieu(chatLieu.getMaChatLieu())) {
                this.lblErrMa.setText("Mã chất liệu " + chatLieu.getMaChatLieu() + " đã tồn tại");
                return;
            } else {
                if (chatLieuService.insertChatLieu(chatLieu)) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (row < 0) {
           diaLogThongBao.thongBao("Chọn dữ liệu để sửa");
            ...
            int id = Integer.parseInt(String.valueOf(this.tblChatLieu.getValueAt(row, 3)));
            ChatLieuModel chatLieuModel = this.getForm();
            if (chatLieuModel == null) {
                return;
            } else {
                if (chatLieuService.isMaChatLieuUnique(id, chatLieuModel.getMaChatLieu())) {
                    ...
                    if (logYesNo.getResult() == JOptionPane.YES_OPTION) {
                           if (chatLieuService.updateChatLieu(id, chatLieuModel)) {
    ...
    private void tblChatLieuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblChatLieuMouseClicked
        ...
        txtMa.setText(this.tblChatLieu.getValueAt(index, 0).toString());
        txtTen.setText(this.tblChatLieu.getValueAt(index, 1).toString());
        if (this.tblChatLieu.getValueAt(index, 2).toString().equals("Đang bán")) {
            rdoHD.setSelected(true);
        } else {
 ...
 private void fillTable() {
        DefaultTableModel defaultTableModel = (DefaultTableModel) this.tblChatLieu.getModel();
        defaultTableModel.setRowCount(0);
        chatLieuService.getAllChatLieu().forEach(item -> defaultTableModel.addRow(new Object[]{
            item.getMaChatLieu(),
            item.getTenChatLieu(),
    ...
    private ChatLieuModel getForm() {
        ...
        if (isValid) {
            chatLieuModel = new ChatLieuModel(ma, Timestamp.valueOf(LocalDateTime.now()), Timestamp.valueOf(LocalDateTime.now()), ten, trangThai);
        }
